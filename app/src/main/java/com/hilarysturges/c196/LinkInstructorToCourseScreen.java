...
public class LinkInstructorToCourseScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final int instructor_id = data.getIntExtra("ID",99);
        final int instructor_index = data.getIntExtra("index",99);
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try{databaseMan.linkInstructorToCourse(Integer.parseInt(courseDetails[4]),instructor_id);}
                catch(Exception e) {System.out.println(e.getMessage());}
                Instructor instructor = MainActivity.instructors.get(instructor_index);
                MainActivity.courses.get(Integer.parseInt(courseDetails[5])).setInstructor(instructor);
